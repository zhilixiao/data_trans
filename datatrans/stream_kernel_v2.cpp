...
static void all_data_flow(ap_uint<32> *pixelOutBuffer, ap_uint<8> *tagOutBuffer){
...
extern "C"{
                    ...
                    )
    {
        ...
        //     read_input(input, instream, loop_index);
        //     truncate(instream, digitOutStream, tagStream);
        //     write_to_onchip_memory(digitOutStream, tagStream, pixelOutBuffer, tagOutBuffer, loop_index);
  
        // }
        all_data_flow(&pixelOutBuffer, &tagOutBuffer);
